...
const pendingAnalysisKeys = {
  all: ['pending-analysis'] as const,
...
export { JOBS_PAGE_DEFAULT, JOBS_PAGE_SIZE_DEFAULT, efficiencyKeys, jobsKeys, partitionKeys, pendingAnalysisKeys, statsKeys, uiSettingsKeys };
